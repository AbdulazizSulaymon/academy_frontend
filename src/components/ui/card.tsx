...
export const BenefitCard: React.FC<BenefitCardProps> = ({
  ...
  return (
    <div
      className={clsx(
        'group relative p-6 rounded-2xl bg-white dark:bg-dark-100 border border-gray-100 dark:border-dark-200 hover:border-primary/20 transition-all duration-500 hover:shadow-xl hover:shadow-primary/5 hover:-translate-y-1 h-full',
        className,
      )}
    >
